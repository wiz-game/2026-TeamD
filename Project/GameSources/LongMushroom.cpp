...
namespace basecross
{
	...
	void LongMushroom::OnCreate()
	{
		AddTag(L"LongMushroom");
		SetIsEditorSave(true);

		auto ptrDraw = AddComponent<PNTStaticDraw>();
		ptrDraw->SetMeshResource(L"M_LongMushroom");
		ptrDraw->SetTextureResource(L"T_LongMushroom");

		auto ptrShadow = AddComponent<Shadowmap>();
		ptrDraw->SetOwnShadowActive(true);
		ptrShadow->SetMeshResource(L"M_LongMushroom");
